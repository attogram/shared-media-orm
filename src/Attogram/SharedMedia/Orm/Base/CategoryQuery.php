 ...
 *
 * @method     \Attogram\SharedMedia\Orm\C2MQuery|\Attogram\SharedMedia\Orm\C2PQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, pageid, title, files, subcats, pages, size, hidden FROM category WHERE id = :p0';
        try {
