...
/**
 * Base class that represents a row from the 'c2p' table.
 *
 *
 *
 * @package    propel.generator.Attogram.SharedMedia.Orm.Base
 */
abstract class C2P implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Attogram\\SharedMedia\\Orm\\Map\\C2PTableMap';
    ...
    /**
     * Initializes internal state of Attogram\SharedMedia\Orm\Base\C2P object.
     */
    ...
    /**
     * Compares this with another <code>C2P</code> instance.  If
     * <code>obj</code> is an instance of <code>C2P</code>, delegates to
     * <code>equals(C2P)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|C2P The current object, for fluid interface
     */
     ...
     * @return $this|\Attogram\SharedMedia\Orm\C2P The current object (for fluent API support)
     */
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[C2PTableMap::COL_CATEGORY_ID] = true;
        }
    ...
    public function setPageId($v)
    {
        ...
        if ($this->page_id !== $v) {
            $this->page_id = $v;
            $this->modifiedColumns[C2PTableMap::COL_PAGE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : C2PTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : C2PTableMap::translateFieldName('PageId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = C2PTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Attogram\\SharedMedia\\Orm\\C2P'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildC2PQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildC2PQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                C2PTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = C2PTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['C2P'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['C2P'][$this->hashCode()] = true;
        $keys = C2PTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Attogram\SharedMedia\Orm\C2P
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Attogram\SharedMedia\Orm\C2P The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        ...
        //relation c2p_fk_904832 to table category
        ...
        //relation c2p_fk_c9a38a to table page
    ...
    {
        return (null === $this->getCategoryId()) && (null === $this->getPageId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Attogram\SharedMedia\Orm\C2P (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Attogram\SharedMedia\Orm\C2P Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aCategory) {
            $this->aCategory->removeC2P($this);
        }
        if (null !== $this->aPage) {
            $this->aPage->removeC2P($this);
        }
    ...
    {
        return (string) $this->exportTo(C2PTableMap::DEFAULT_STRING_FORMAT);
    }
