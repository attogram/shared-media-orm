 ...
 *
 * @method     ChildPageQuery leftJoinSource($relationAlias = null) Adds a LEFT JOIN clause to the query using the Source relation
 * @method     ChildPageQuery rightJoinSource($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Source relation
 * @method     ChildPageQuery innerJoinSource($relationAlias = null) Adds a INNER JOIN clause to the query using the Source relation
 *
 * @method     ChildPageQuery joinWithSource($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Source relation
 *
 * @method     ChildPageQuery leftJoinWithSource() Adds a LEFT JOIN clause and with to the query using the Source relation
 * @method     ChildPageQuery rightJoinWithSource() Adds a RIGHT JOIN clause and with to the query using the Source relation
 * @method     ChildPageQuery innerJoinWithSource() Adds a INNER JOIN clause and with to the query using the Source relation
 *
 ...
 *
 * @method     \Attogram\SharedMedia\Orm\SourceQuery|\Attogram\SharedMedia\Orm\C2PQuery|\Attogram\SharedMedia\Orm\M2PQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPage requireOneByCreatedAt(string $created_at) Return the first ChildPage filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPage requireOneByUpdatedAt(string $updated_at) Return the first ChildPage filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPage[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildPage objects filtered by the created_at column
 * @method     ChildPage[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildPage objects filtered by the updated_at column
