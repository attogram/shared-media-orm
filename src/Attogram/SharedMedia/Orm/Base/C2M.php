...
/**
 * Base class that represents a row from the 'c2m' table.
 *
 *
 *
 * @package    propel.generator.Attogram.SharedMedia.Orm.Base
 */
abstract class C2M implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Attogram\\SharedMedia\\Orm\\Map\\C2MTableMap';
    ...
    /**
     * Initializes internal state of Attogram\SharedMedia\Orm\Base\C2M object.
     */
    ...
    /**
     * Compares this with another <code>C2M</code> instance.  If
     * <code>obj</code> is an instance of <code>C2M</code>, delegates to
     * <code>equals(C2M)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|C2M The current object, for fluid interface
     */
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[C2MTableMap::COL_CATEGORY_ID] = true;
        }
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[C2MTableMap::COL_MEDIA_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : C2MTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : C2MTableMap::translateFieldName('MediaId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = C2MTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Attogram\\SharedMedia\\Orm\\C2M'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildC2MQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildC2MQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                C2MTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(C2MTableMap::COL_CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'category_id';
        }
        if ($this->isColumnModified(C2MTableMap::COL_MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'media_id';
        }

        $sql = sprintf(
            'INSERT INTO c2m (%s) VALUES (%s)',
    ...
    {
        $pos = C2MTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['C2M'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['C2M'][$this->hashCode()] = true;
        $keys = C2MTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Attogram\SharedMedia\Orm\C2M
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Attogram\SharedMedia\Orm\C2M The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(C2MTableMap::COL_CATEGORY_ID)) {
            $criteria->add(C2MTableMap::COL_CATEGORY_ID, $this->category_id);
        }
        if ($this->isColumnModified(C2MTableMap::COL_MEDIA_ID)) {
            $criteria->add(C2MTableMap::COL_MEDIA_ID, $this->media_id);
        }
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getCategoryId() &&
            null !== $this->getMediaId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation c2m_fk_904832 to table category
        ...
        //relation c2m_fk_32dfd1 to table media
    ...
    {
        return (null === $this->getCategoryId()) && (null === $this->getMediaId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Attogram\SharedMedia\Orm\C2M (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Attogram\SharedMedia\Orm\C2M Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aCategory) {
            $this->aCategory->removeC2M($this);
        }
        if (null !== $this->aMedia) {
            $this->aMedia->removeC2M($this);
        }
    ...
    {
        return (string) $this->exportTo(C2MTableMap::DEFAULT_STRING_FORMAT);
    }
